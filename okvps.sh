...
mkdir -p $HOME/BB/wordlist
	...
	./install.sh
 	...
 	cd $HOME/BB
  	mkdir dorker
   	cd $HOME/BB/dorker
    	npm install axios puppeteer puppeteer-extra puppeteer-extra-plugin-recaptcha request-promise-core node-fetch fs url async puppeteer-extra-plugin-stealth unirest cheerio request-promise request request-promise-native path fs string-similarity axios --save
	npm audit fix --force
  	sudo chmod 777 *
  	...
  	wget https://raw.githubusercontent.com/Nishantbhagat57/OK-VPS/main/ffufpp1.json -O $HOME/.axiom/modules/ffufpp1.json
   	wget https://raw.githubusercontent.com/Nishantbhagat57/OK-VPS/main/ffufpp2.json -O $HOME/.axiom/modules/ffufpp2.json
    	wget https://raw.githubusercontent.com/Nishantbhagat57/OK-VPS/main/ffufpp3.json -O $HOME/.axiom/modules/ffufpp3.json
     	wget https://raw.githubusercontent.com/Nishantbhagat57/OK-VPS/main/ffufpp3.json -O $HOME/.axiom/modules/ffufpp4.json
